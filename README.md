...
| 機能名                                   | 機能概要                                                                                                       |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| TBL出力（一時テーブル→設備データ管理マスタテーブル） | 一時テーブルから取得したデータに管理用ID等の属性を追加し、設備データ管理マスタテーブルに登録する。一時テーブルのデータは削除する。 |
...
6. 実行ログを確認します。
    ...
    ```
    [2026-02-03 18:54:58,621] [INFO] [FDI] BPI0001:FDI_0080_TBL出力（一時テーブル→設備データ管理マスタテーブル）処理 開始
    [2026-02-03 18:54:58,710] [INFO] [FDI] BPI0002:FDI_0080_TBL出力（一時テーブル→設備データ管理マスタテーブル）処理 終了
    ```
